  ...
  return (
    <>
      <div className="main">
        ...
        <BackgroundAdd1 />
        <OfferZone/>
        {/* <div className='relative w-[100%] h-[218vh] bg-[#A9E5FF]'>
