    ...
    return (
        <div className='relative w-[100%] h-[100vh] bg-[#A9E5FF] z-50 cursor-pointer overflow-hidden rounded-tl-[2vw] rounded-tr-[2vw] rounded-br-[2vw] rounded-bl-[2vw] '>
            <div className="relative ShopContainer w-4/5 h-full left-1/2 -translate-x-1/2 flex justify-center z-20 -top-6 ">
                ...
                <div className="relative windowIMG w-[66vw] h-[34vw] overflow-hidden -top-7 z-20 ">
                    <Image src="/IMG/canopy.jpg" alt="canopy img" className='absolute object-contain' fill sizes='100vw, 100vw' quality={100} />
                </div>
            </div>
            <div className="absolute z-10 cardBG w-3/5 h-[68%]  bottom-0 left-1/2 -translate-x-1/2 flex justify-between shadow-xl shadow-gray-900 shadow-l-[2vw] shadow-r-[2vw] shadow-spread-6 overflow-hidden ">
                <div className='absolute w-[60vw] h-[38vw] overflow-hidden left-0'>
                    <Image src="/IMG/wall2.png" alt="wall" className='absolute w-[100%] h-[100%] z-20 object-contain object-left' fill sizes='100vw, 100vw' quality={100} />
                </div>
                    ...
                    <div className="flex sContain1 min-w-[100%] min-h-[100%] ">
                        {group1.map((element, index) => (
                            <div className='relative  h-[80%] w-[100%] flex justify-center' key={index}>
                                <div className='relative widnows  w-[16.5vw] h-[26vw]'>
                                    <Image src="/IMG/window7.png" alt="windowImg" className='absolute w-[100%] h-[100%] object-contain z-30' fill sizes='60vw, 60vw' quality={100} />
                                </div>
                                <div className="sIMG absolute w-[57%] h-[55.5%] z-30 bottom-6 left-[49%] -translate-x-1/2">
                                    <div className="relative styles w-[11.6vw] h-[14vw] overflow-hidden">
                                        <Image src={element[0]} alt="shop" className='absolute w-[100%] h-[100%] object-cover rounded-md' fill sizes='70vw, 70vw' quality={100} />
                                    </div>
                                    <h1 className='absolute  text-sm p-[0.1vw] w-full visit top-1/2 -translate-y-[65%] text-center font-bold  uppercase'>{element[1]}</h1>
                                </div>
                                <button className="absolute  w-auto px-4 h-6 left-[6vw] rounded-2xl top-[8.3vw] bg-yellow-400 z-30 uppercase text-sm font-bold text-gray-800 shadow-md shadow-gray-900/60 shadow-t-[1px] shadow-spread-6 Outfit2">Visit Shop</button>
                                <button className="absolute bg-[#C1B1A2] w-[59%] px-4 h-6 left-[4.1vw] top-[22.2vw] rounded-sm flex justify-center items-center z-30  text-sm Outfit2 text-gray-800 shadow-md shadow-gray-900/60 shadow-t-[1px] shadow-spread-6 Outfit2">{element[2]}</button>
                                <div className="info -bottom-[6vw] left-[3vw] absolute w-[70%] text-gray-800  z-30 flex flex-col gap-1 justify-center pointer-events-auto">
                    ...
                    <div className=" flex sContain2 min-w-[100%] min-h-[100%]">
                        {group2.map((element, index) => (
                            <div className='relative  h-[80%] w-[100%] flex justify-center' key={index}>
                                ...
                                <div className="sIMG absolute w-[57%] h-[55.5%] z-30 bottom-6 left-[49%] -translate-x-1/2">
                                    <div className="relative styles w-[11.5vw] h-[14vw] overflow-hidden left-[0.2vw]">
                                        <Image src={element[0]} alt="shop" className='absolute w-[100%] h-[100%] object-cover rounded-md' fill sizes='70vw, 70vw' quality={100} />
                                    </div>
                                    <h1 className='absolute  text-sm p-[0.1vw] w-full visit top-1/2 -translate-y-[65%] text-center font-bold  uppercase'>{element[1]}</h1>
                                </div>
                                <button className="absolute  w-auto px-4 h-6 left-[6vw] rounded-2xl top-[8.3vw] bg-yellow-400 z-30 uppercase text-sm font-bold text-gray-800 shadow-md shadow-gray-900/60 shadow-t-[1px] shadow-spread-6">Visit Shop</button>
                                <button className="absolute bg-[#C1B1A2] w-[59%] px-4 h-6 left-[4.1vw] top-[22.2vw] rounded-sm  z-30 flex justify-center items-center text-sm text-gray-800 shadow-md shadow-gray-900/60 shadow-t-[1px] shadow-spread-6 Outfit2">{element[2]}</button>
                    ...
                    <div className=" flex sContain3 min-w-[100%] min-h-[100%]">
                        {group3.map((element, index) => (
                            <div className='relative  h-[80%] w-[100%] flex justify-center' key={index}>
                                ...
                                <button className="absolute  w-auto px-4 h-6 left-[6vw] rounded-2xl top-[8.3vw] bg-yellow-400 z-30 uppercase text-sm font-bold text-gray-800 shadow-md shadow-gray-900/60 shadow-t-[1px] shadow-spread-6">Visit Shop</button>
                                <button className="absolute bg-[#C1B1A2] w-[59%] px-4 h-6 left-[4.1vw] top-[22.2vw] rounded-sm z-30 flex justify-center items-center text-sm  text-gray-800 overflow-hidden shadow-md shadow-gray-900/60 shadow-t-[1px] shadow-spread-6 Outfit2">{element[2]}
                                </button>
                                <div className="info -bottom-[6vw] left-[3.2vw] absolute w-[70%] text-gray-800  z-30 flex flex-col gap-1 justify-center">
